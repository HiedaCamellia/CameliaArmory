...
public class CARecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                Ingredient.of(CAItem.BASTARD_SWORD.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.CLAYMORE.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.HALBERD.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.HENGDAO.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.LUCERNE_HAMMER.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.PIKE.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.SCYTHE.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.SPEAR.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.TACHI.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.UCHIGATANA.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.WAKIZASHI.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.THROWING_KNIFE.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.THROWING_AXE.get("diamond")),
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        Ingredient.of(CAItem.SPINY_MAUL.get("diamond")),
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT,CAItem.KOMACHI_SCYTHE)
                .pattern(" T ")
                .pattern("S T")
                .pattern("S  ")
                .define('S', Items.STICK)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT,CAItem.LONG_STICK)
                .pattern("P  ")
                .pattern("P  ")
                .pattern("P  ")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT,CAItem.MACUAHUITL)
                .pattern("TST")
                .pattern("TST")
                .pattern(" S ")
                .define('S', Items.STICK)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT,CAItem.ENGLAND_LONGBOW)
                .pattern(" ST")
                .pattern("S T")
                .pattern("ST ")
                .define('S', Items.STICK)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT,CAItem.YUMI)
                .pattern("S  ")
                .pattern("LS ")
                .pattern("S  ")
